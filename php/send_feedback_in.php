...
$sql = "INSERT INTO investor_feedback (name, email, feedback_type, feedback) VALUES ('$name', '$email', '$subject', '$message')";

if (mysqli_query($conn, $sql)) {
    echo '<script type="text/javascript">alert("Feedback submitted.");</script>';
        // Redirect to buttons.html
    header("Location: investor_feedback.html");
    exit();
    ...
    echo '<script type="text/javascript">window.location.href = "investor_feedback.html";</script>';
}
